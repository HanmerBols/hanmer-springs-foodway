import { DailySpecials, DayOfTheWeek } from "./types";
...
export const DAILY_SPECIALS: DailySpecials = {
    Monday: {
        ...
        discountedPrice: 16,
        regularPrice: 24,
        description: "Korean mixed rice with veggies (bean sprouts, kale, pickled radish, zucchini, mushroom, carrots, edamame) and your choice of crispy tofu, chicken bulgogi, or beef bulgogi. Topped with sunny side up egg and house \"gochujang\" sauce on the side."
    },
    Tuesday: {
    ...
    Friday: {
        ...
        discountedPrice: 16,
        regularPrice: 24,
        description: "Rice bowl with panko breaded chicken breast katsu, topped with donkatsu (Asian BBQ) and chipotle aioli."
    },
    Saturday: {
        ...
        discountedPrice: 16,
        regularPrice: 24,
        description: "Bao bun stuffed with panko fried chicken breast, cilantro,carrots, pickled radish, walnuts, and housemade brown sauce. 2pc"
    },
    Sunday: {
        ...
        discountedPrice: 16,
        regularPrice: 24,
        description: "Crispy fried chicken wings tossed in Korean sweet & spicy sauce. 8pc"
    },
}
