...
export const TERMS_AND_CONDITIONS: SectionContent[] = [
  ...
  },
  {
    ...
    points: [
      ...
      {
        text: "We reserve the right to refuse or cancel any order at our discretion, including if fraud or unauthorized transactions are suspected.",
      },
    ],
  },
  {
    ...
    points: [
      ...
      {
        text: "We strive to display accurate pricing, but errors may occur. If we discover an error in pricing, we will inform you and offer the option to confirm your order at the correct price or cancel it.",
      },
    ],
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        text: "You can choose to collect your order from our store during designated hours.",
      },
      {
        text: "We are not responsible for delays or non-delivery due to incorrect information provided by you.",
      },
    ],
  },
  {
    ...
    points: [
      ...
      {
        subheader: "Non-Perishable Items:",
        text: "You may return non-perishable items within 7 days of delivery for a refund, provided they are unopened and in original condition.",
      },
      {
        subheader: "Refund Process:",
        text: "Refunds will be processed within 7 business days after we receive the returned items or confirm the defect.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      {
        text: "By using our services, you consent to the collection and use of your personal data as outlined in our Privacy Policy.",
      },
    ],
  },
  {
    ...
    points: [
      ...
      {
        text: "Our liability for any claim arising out of or in connection with your use of our services shall not exceed the total amount paid by you for the order.",
      },
    ],
  },
  {
    ...
    points: [
      ...
      {
        text: "Your continued use of our services after any changes constitute your acceptance of the new Terms and Conditions.",
      },
    ],
  },
  {
